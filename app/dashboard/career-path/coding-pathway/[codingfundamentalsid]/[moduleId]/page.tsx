...
const Page = ({ params }: any) => {
  ...
  const numberOfQuizzes = moduleDetails.filter((detail) => detail.quiz_url)
    .length;
                              ...
                              <div className="space-y-5 font-medium">
                                ...
                                <div>
                                  <p
                                    className={`mt-5 cursor-pointer
                                  ${
                                    activeLessonIndex === index && (isLessonMode && !isQuizMode && !isVideoMode)
                                      ? "text-purple-500"
                                      : ""
                                  }`}
                                    onClick={() =>
