            ...
            <div className="mt-10">
              <div>
                <form className="space-y-6">
                    ...
                    <>
                      <div className="w-full">
                        ...
                        <div className="mt-2">
                          <input
                            ...
                            ${
                              errors.student?.fullname ? "focus:border-red-500" : "focus:border-black"
                            }`}
                          />
                          {errors.student?.fullname && (
                      ...
                      <div className="w-full">
                        ...
                        <div className="mt-2 relative">
                          ...
                          <select
                            id="student.age"
                            {...register("student.age", { required: true, valueAsNumber: true })}
                            ...
                            ${errors.student?.age ? "focus:border-red-500" : "focus:border-black"}`}
                           >
                      ...
                      <div className="flex gap-6">
                        <div className="w-1/2">
                          ...
                          <div className="mt-2 relative">
                            ...
                            <select
                              id="student.country"
                              disabled={isLoading}
                              {...register("student.country", { required: true })}
                              className={`relative appearance-none block outline-none w-full bg-transparent rounded-md border border-gray-600 py-4 px-4 shadow-sm ring-1 ring-inset ring-gray-300 text-gray-700 focus:ring-2 focus:ring-inset focus:ring-purple-600 sm:text-sm sm:leading-6 ${
                            ...
                            ${
                              errors.student?.country ? "focus:border-red-500" : "focus:border-black"
                            }`}
                            >
                        ...
                        <div className="w-1/2">
                          ...
                          <div className="mt-2 relative">
                            ...
                            ${
                              errors.student?.state ? "focus:border-red-500" : "focus:border-black"
                            }`}
                            >
                      ...
                      <div className="flex gap-6">
                        <div className="w-1/2">
                          ...
                          <div className="mt-2 relative">
                            ...
                            <select
                              id="student.pathway"
                              disabled={isLoading}
                              {...register("student.pathway", { required: true })}
                              className={`relative appearance-none block outline-none w-full bg-transparent rounded-md border border-gray-600 py-4 px-4 shadow-sm ring-1 ring-inset ring-gray-300 text-gray-700 focus:ring-2 focus:ring-inset focus:ring-purple-600 sm:text-sm sm:leading-6 ${
                            ...
                            ${
                              errors.student?.pathway ? "focus:border-red-500" : "focus:border-black"
                            }`}
                            >
                        ...
                        <div className="w-1/2">
                          ...
                          <div className="mt-2 relative">
                            ...
                            ${
                              errors.student?.stage ? "focus:border-red-500" : "focus:border-black"
                            }`}
                            >
                              <option value="" className="text-gray-600">Select Stage</option>
                              {
                      ...
                      <div className="w-full">
                        ...
                        <div className="mt-2 relative">
                          ...
                          <select
                            ...
                            ${
                              errors.student?.course ? "focus:border-red-500" : "focus:border-black"
                            }`}
                          >
                  ...
                  {step === STEPS.PAYMENT_PLAN && (
                    <>
                    <div className="mx-auto mt-9 md:mt-16 lg:mt-20 
