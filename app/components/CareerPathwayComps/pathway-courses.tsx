...
const pathwayCourses = [
    {pathway: "Gaming", courses: 50, 
    lessons: 120, projects: 20, 
    courseslist:["Lorem ipsum dolor sit ame", "Lorem ipsum dolor sit ame",
     "Lorem ipsum dolor sit ame", "Lorem ipsum dolor sit ame", "Lorem ipsum dolor sit ame", "Lorem ipsum dolor sit ame"] },

    {pathway: "Coding", courses: 50, 
    lessons: 120, projects: 20, 
    courseslist:["Lorem ipsum dolor sit ame", "Lorem ipsum dolor sit ame",
    "Lorem ipsum dolor sit ame", "Lorem ipsum dolor sit ame", "Lorem ipsum dolor sit ame", "Lorem ipsum dolor sit ame"] },

    {pathway: "Multimedia", courses: 50, 
    lessons: 120, projects: 20, 
    courseslist:["Lorem ipsum dolor sit ame", "Lorem ipsum dolor sit ame",
    "Lorem ipsum dolor sit ame", "Lorem ipsum dolor sit ame", "Lorem ipsum dolor sit ame", "Lorem ipsum dolor sit ame"] },

    {pathway: "Robotics & IOT", courses: 50, 
    lessons: 120, projects: 20, 
    courseslist:["Lorem ipsum dolor sit ame", "Lorem ipsum dolor sit ame",
    "Lorem ipsum dolor sit ame", "Lorem ipsum dolor sit ame", "Lorem ipsum dolor sit ame", "Lorem ipsum dolor sit ame"] },

    {pathway: "AI", courses: 50, 
    lessons: 120, projects: 20, 
    courseslist:["Lorem ipsum dolor sit ame", "Lorem ipsum dolor sit ame",
    "Lorem ipsum dolor sit ame", "Lorem ipsum dolor sit ame", "Lorem ipsum dolor sit ame", "Lorem ipsum dolor sit ame"] },

    {pathway: "Techpreneurship", courses: 50, 
    lessons: 120, projects: 20, 
    courseslist:["Lorem ipsum dolor sit ame", "Lorem ipsum dolor sit ame",
    "Lorem ipsum dolor sit ame", "Lorem ipsum dolor sit ame", "Lorem ipsum dolor sit ame", "Lorem ipsum dolor sit ame"] },
]
            ...
            <div className="w-[93%] md:w-[90%] lg:w-[88%] mx-auto mt-9 md:mt-16 mb-20 space-y-8">
                {pathwayCourses.map((pathway,index) => (
                    <div className="bg-blue-50 border border-blue-200 py-8 px-5 md:px-8 flex flex-col rounded-3xl">
                        <div className="flex justify-between">
                                <div className="flex gap-2 md:gap-5 lg:gap-8">
                                    ...
                                    <div className="text-black-500">
                                        <h2 className="font-semibold text-xl md:text-3xl lg:text-4xl">{pathway.pathway} Pathway</h2>
                                        <p className="mt-3 text-black-800 md:text-2xl">{pathway.courses} Courses, {pathway.lessons} Lessons, {pathway.projects} Projects</p>
                                    </div>
                                </div>
                        ...
                        >
                            <div>
                                <h3 className="font-semibold text-black-500 text-xl md:text-2xl">Courses they will learn</h3>
