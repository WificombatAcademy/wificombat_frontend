"use client"
import { FormValues } from "@/app/create-profile/page";
...
export const PricingCard = ({billing, defaultStyle, price, color, linkTo, boxShadow, setValue, selectedPlan, onSelect}: Props) => {
