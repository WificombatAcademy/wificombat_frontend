...
export const FreeCourses = () => {
  ...
  return (
    <section className="relative mt-16">
      ...
      <h3 className="w-[90%] mx-auto text-center text-2xl md:text-4xl font-semibold">Explore Our Collection of Free Courses</h3>
...
//       </h3>
//       <p className="mt-9 md:w-[80%] lg:w-[65%] mx-auto text-center md:text-xl">
//         Access professional-grade courses that help you build essential skills at your own pace.
//       </p>
...
//                   ? course.image 
//                   : `https://wificombatacademy.com${course.image}`}
//                 level={course.level}
//                 desc={course.note.replace(/<\/?[^>]+(>|$)/g, "")}
//                 linkTo={`/free-course/${course.course_id}`}
//                 viewCourse={true}
//                 price={course.price === "0.00" ? "Free" : course.price}
//               />
...
//         <div className="relative w-[93%] md:w-[90%] lg:w-[88%] mx-auto mt-8 md:mt-12 flex items-center justify-between">
//           <div className="courses-swiper-button-prev bg-transparent w-9 h-9 md:w-14 md:h-14 rounded flex items-center justify-center transition duration-500 ease-in-out max-m cursor-pointer">
//             <GrFormPrevious size={28} />
//           </div>
...
//           <div className="courses-swiper-button-next bg-transparent w-9 h-9 md:w-14 md:h-14 rounded flex items-center justify-center transition duration-500 ease-in-out max-m cursor-pointer">
//             <GrFormNext size={28} />
//           </div>
//         </div>
//       </div>
