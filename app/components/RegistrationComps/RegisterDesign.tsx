        ...
        <div className="absolute inset-0 w-full max-lg:hidden">
           ...
           <div className="absolute right-2 lg:right-[18%] top-[6px] lg:top-7">
                 <svg width="42" height="40" viewBox="0 0 42 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M21 0L25.9393 15.2016H41.9232L28.992 24.5967L33.9313 39.7984L21 30.4033L8.06872 39.7984L13.008 24.5967L0.0767574 15.2016H16.0607L21 0Z" fill="#0784C3"/>
                </svg>
           </div>
            {/* 3RD DESIGN */}
            ...
            <div className="absolute bottom-[9%] right-[8%]">
               <Image src={`/reg-design4.png`} alt="design" width={44} height={44} className="object-contain aspect-auto"/>
            </div>
            {/* 5TH DESIGN */}
            ...
            <div className="absolute left-[6%] top-[35%]">
               <Image src={`/reg-design7.png`} alt="design" width={44} height={44} className="object-contain aspect-auto"/>
            </div>
