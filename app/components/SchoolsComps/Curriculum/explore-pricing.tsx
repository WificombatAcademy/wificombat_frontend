...
export const ExplorePricingPlan = () => {
    return (
        <section className="py-10 md:py-14 lg:py-20 bg-blue-50">
            ...
            <p className="mt-9 md:w-[80%] lg:w-[65%] mx-auto text-center md:text-xl">Don't wait! Contact us now to receive a free quote and learn more about our affordable solutions. </p>
