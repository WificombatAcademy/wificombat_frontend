...
//               },
//               1000: {
//                 slidesPerView: 2, // Smaller number of slides to prevent overflow
//                 spaceBetween: 30,
//               },
//               1200: {
//                 slidesPerView: 3,
...
//                 <div className="flex w-[800px] h-[524px] rounded-xl overflow-hidden">
...
//                     />
//                   </div>
//                   <div className="w-[500px] h-[550px] rounded-r-xl bg-white text-black text-left p-5">
//                     <h2 className="font-semibold text-lg">{testimonial.name}</h2>
//                     <h4 className="font-semibold text-lg">{testimonial.role}</h4>
