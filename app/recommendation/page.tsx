...
const reasons = [
    ...
    {title: "Skill Alignment", desc: "You love [specific skill]? That's awesome! It's just like a super power for coding! You're going to be amazing!"},
    {title: "Coding Career Outlook", desc: "Coders create amazing things! Imagine building video games, designing websites, or even helping robots learn new tricks. With coding skills, you can solve problems, be creative, and make a difference in the world!"},
    {title: "Next Step", desc: "Ready to start coding? Let's go! Try our fun coding games, solve puzzles, or work on projects to build something awesome!", buttonText: "Get Started", linkTo:"/registration"},
]
            ...
            <div className="w-full relative">
                ...
                <div className="mt-16 md:mt-24 w-full bg-blue-50 py-12">
                    ...
                    flex flex-col md:flex-row md:items-center gap-10 md:gap-14 lg:gap-20 text-black-500">
                        ...
                        <div className="w-full md:basis-[50%]">
                            <h2 className="text-blue-500 font-semibold text-xl md:text-2xl lg:text-4xl">Coding Pathway</h2>
